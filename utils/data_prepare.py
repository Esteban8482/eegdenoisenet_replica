...
def random_signal(signal,combin_num):
    """This function is used to shuffle the order of the signal segments, 
    and generate new signal segments by combinating the shuffled segments."""
    random_result=[]
...
def prepare_data(EEG_all, noise_all, combin_num, train_per, noise_type):
    """
    Used to prepare the training, validation and test data, 
    by shuffling the order of the signal segments.
    """
